...
import com.mock.model.AuthTokenInfo;
import com.mock.model.UserVO;
	 
		  
	public class SpringRestClient {
	  
		public static final String REST_SERVICE_URI = "http://localhost:8080/segur-api";
	     
	    public static final String AUTH_SERVER_URI = "http://localhost:8080/segur-api/oauth/token";
	    ...
	    private static HttpHeaders getHeadersWithClientCredentials(){
	        String plainClientCredentials="myRestClient:P@ssw0rd";
	    ...
	    private static void getUser(AuthTokenInfo tokenInfo){
	        ...
	        RestTemplate restTemplate = new RestTemplate();
	        HttpEntity<String> request = new HttpEntity<String>(getHeaders());
	        ResponseEntity<UserVO> response = restTemplate.exchange(REST_SERVICE_URI+"/user/1"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
	                HttpMethod.GET, request, UserVO.class);
	    ...
	    private static void updateUser(AuthTokenInfo tokenInfo) {
	        ...
	        RestTemplate restTemplate = new RestTemplate();
	        UserVO user  = new UserVO(1,"Tomy",33, 70000);
	        HttpEntity<Object> request = new HttpEntity<Object>(user, getHeaders());
	        ResponseEntity<UserVO> response = restTemplate.exchange(REST_SERVICE_URI+"/user/1"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
	                HttpMethod.PUT, request, UserVO.class);
	    ...
	    private static void deleteUser(AuthTokenInfo tokenInfo) {
	        ...
	        restTemplate.exchange(REST_SERVICE_URI+"/user/3"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
	                HttpMethod.DELETE, request, UserVO.class);
	    }
